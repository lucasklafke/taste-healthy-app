    ...
    <div className={styles.inputContainer}>
      <form autoComplete='off' onSubmit={(e) => handleSubmit(e)}>
          ...
          <div>
            ...
            <input className={styles.input} placeholder='Digite sua senha' type='password' autoComplete='off' value={password} onChange={(e) => setPassword(e.target.value)}/>
          </div>
          <div className={styles.confirmContainer}>
            <button className={styles.confirmButton}>Entrar</button>
            <div className={styles.checkBoxContainer}>
              <input type='checkbox' onClick={() => setRemeberUser(!remeberUser)}></input>
